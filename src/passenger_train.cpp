...
passenger_train::passenger_train(const string &file_path) : train{file_path} {
}

size_t passenger_train::calculate_train_ticket_price(const string &src_railway_station,
                                                     const string &dst_railway_station, float discount) const {
    // 0   - 19  km: 400Ft
    // 20  - 99  km: 1000Ft
    // 100 - 199 km: 1800Ft
    // above 200 km: 5000Ft
